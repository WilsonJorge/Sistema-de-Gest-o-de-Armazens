...
<div class="app-footer">
    <div class="footer-bottom pt-3 d-flex flex-column flex-sm-row align-items-center">
        ...
        <div class="d-flex align-items-center">
            ...
            <a href="https://up.ac.mz/" target="_blank">
                <img class="logo" src="{{ asset('dist-assets/images/logo_up.png') }}" style="width: 40px;" alt=""> 
            </a>
            <div>
                <p class="m-0">&copy; {{ date('Y') }} Universidade Pedagógica de Maputo </p>
                <p class="m-0">Todos direitos reservados-Adelson Saguate</p>
            </div>
        </div>
    </div>
</div>
